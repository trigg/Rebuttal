...
const mysqlstorage = {
    ...
    getRoomByID: async function (roomid) {
        return this.conn.execute(this.sqlGetRoomsByID, [roomid], (err, rows) => {
            if (err) { throw (err); }
    ...
    start: async function () {
        ...
        console.log("Connecting DB : " + this.mysql_host + " uN : " + this.mysql_username + " pW : " + this.mysql_password + " DB : " + this.mysql_password);
    },
    ...
    test_passalong: async function (f) { f() },
}
